document.addEventListener("DOMContentLoaded", function () {
  // ORIGINAL DESKTOP FUNCTIONALITY - INTEGRATED FROM PROVIDED JAVASCRIPT
  ...
  // Desktop Notifications toggle - ORIGINAL CODE WITH CORRECT ID
  ...
  // NEW MOBILE FUNCTIONALITY - ADDED FOR MOBILE RESPONSIVENESS
  
  // Mobile elements
  const hamburger = document.getElementById("hamburger");
  const mobileSidebarOverlay = document.getElementById("mobile-sidebar-overlay");
  const mobileSidebar = document.getElementById("mobile-sidebar");
  const mobileNotificationToggle = document.getElementById("notification-btn-mobile");
  ...
  // PWA Install functionality - FOR INSTALL BUTTONS
  let deferredPrompt;
